  ...
  const industries = [
    {
      ...
      icon: <Building2 className="w-12 h-12 text-[#9b87f5] mb-4" />,
      description: "End-to-end dairy supply chain solutions",
      image: "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d"
    },
    {
      title: "Insurance Services",
      icon: <Globe className="w-12 h-12 text-[#9b87f5] mb-4" />,
      description: "Rural insurance delivery platform",
      image: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7"
    },
    {
      title: "Financial Solutions",
      icon: <BriefcaseBusiness className="w-12 h-12 text-[#9b87f5] mb-4" />,
    ...
    <section className="py-20 bg-gradient-to-b from-[#F3F4F6] to-white">
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto mb-20">
          ...
          <div className="space-y-8">
            <div className="text-center lg:text-left">
              <h2 className="text-3xl font-bold text-[#6E59A5] mb-4 flex items-center justify-center lg:justify-start gap-2">
                <Truck className="w-8 h-8 text-[#9b87f5]" />
                First Mile as a Service
              </h2>
            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-[#E2E8F0]">
              <div className="p-6">
                <h3 className="text-xl font-semibold text-[#6E59A5] mb-6">Addressing Critical Gaps in Rural India</h3>
                  ...
                  {problems.map((problem, index) => (
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="font-semibold text-[#6E59A5] mb-1">{problem.title}</h4>
                          <p className="text-sm text-[#7E69AB]">{problem.description}</p>
                        </div>
                      </div>
                    </div>
                  ))}
          ...
          <div className="space-y-8">
            <div className="text-center lg:text-left">
              <h2 className="text-3xl font-bold text-[#6E59A5] mb-4 flex items-center justify-center lg:justify-start gap-2">
                <Rocket className="w-8 h-8 text-[#9b87f5]" />
                Tech Solutions at SPEED
              </h2>
              <p className="text-[#7E69AB]">
              ...
              <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="group p-6 rounded-lg bg-[#F8FAFC] hover:bg-[#F1F5F9] transition-all duration-300">
                    <Brain className="w-8 h-8 text-[#9b87f5] mb-4" />
                    <h3 className="text-xl font-semibold text-[#6E59A5] mb-2">
                  ...
                  <div className="group p-6 rounded-lg bg-[#F8FAFC] hover:bg-[#F1F5F9] transition-all duration-300">
                    <Blocks className="w-8 h-8 text-[#9b87f5] mb-4" />
                    <h3 className="text-xl font-semibold text-[#6E59A5] mb-2">
                  ...
                  <div className="group p-6 rounded-lg bg-[#F8FAFC] hover:bg-[#F1F5F9] transition-all duration-300">
                    <DollarSign className="w-8 h-8 text-[#9b87f5] mb-4" />
                    <h3 className="text-xl font-semibold text-[#6E59A5] mb-2">
                      Competitive Pricing
                    </h3>
                    <p className="text-[#7E69AB]">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-[#6E59A5] mb-4">
            Industry Coverage
          </h2>
          ...
          {industries.map((industry, index) => (
            ...
            >
              <div className="relative h-48 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#9b87f5]/90 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
              <div className="p-6 text-center">
                {industry.icon}
                <h3 className="text-xl font-semibold text-[#6E59A5] mb-2">{industry.title}</h3>
                <p className="text-[#7E69AB]">{industry.description}</p>
              </div>
            </div>
          ))}
        </div>
