        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-lg text-gray-700 leading-relaxed animate-fade-in">
              In today's data-rich environment, businesses need more than raw data; they need actionable insights to drive strategic decisions. Krushal harnesses the power of AI to transform complex data into clear, actionable insights, empowering organizations to thrive.
            </p>
          </div>
        </div>
      </section>
